# Template Portfolio 2 - Diseño Moderno Azul

## 📋 Descripción

Template profesional moderno con paleta de colores azul e indigo. Diseñado para psicólogas que buscan una imagen más contemporánea y minimalista.

### Características

✅ **Diseño Moderno y Minimalista**
- Paleta de colores azul profesional (Azul → Indigo → Slate)
- Tipografía moderna y limpia
- Espacios amplios con fondo slate
...
Incluye las mismas optimizaciones avanzadas que el Portfolio 1:
